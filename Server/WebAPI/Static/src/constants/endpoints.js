...
export const GET_CAR_WASH_ENDPOINT = "api/company/profile/car-wash/{id}";
export const ADD_CAR_WASH_ENDPOINT = "api/company/profile/car-wash";
export const UPDATE_CAR_WASH_ENDPOINT = "api/company/profile/car-wash/{id}";
export const DELETE_CAR_WASH_ENDPOINT = "api/company/profile/car-wash/{id}";
