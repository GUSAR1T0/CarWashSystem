...
const routes = [
    ...
    {
        path: "/profile/car-wash/:id/appointment/:appointmentId",
        name: "carWashAppointmentView",
        component: () => import(/* webpackChunkName: "car-wash-appointment-view" */ "../views/company-profile/CarWashAppointmentView.vue")
    }
];
