...
struct AuthenticationViewText {
    ...
    static let SignUpButtonText = "Create"
    static let QuestionAboutAccountExist = "Don't have an account?"
    static let QuestionAboutSocialAuthorization = "Log in using any social?"
}
